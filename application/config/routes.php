...
*/
$route['default_controller'] = 'VegesHome';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;

$route['home'] = $route['default_controller'];
$route['login'] = $route['default_controller'].'/login';
$route['register'] = $route['default_controller'].'/register';
$route['guest-login'] = $route['default_controller'].'/guestLogin';
$route['forgot-username'] = $route['default_controller'].'/forgotUsername';
$route['forgot-password'] = $route['default_controller'].'/forgotPassword';

$route['product'] = $route['default_controller'].'/product';
$route['product-details'] = $route['default_controller'].'/productDetails';

$route['about-us'] = $route['default_controller'].'/aboutUs';
$route['contact-us'] = $route['default_controller'].'/contactUs';

$route['cart'] = $route['default_controller'].'/cart';
